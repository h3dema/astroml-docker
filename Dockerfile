...
# download the course files in root home directory
RUN cd /root && git clone https://github.com/dirac-institute/SPSAS2019.git
...
RUN echo "alias j=\"jupyter notebook\"" >> /root/.bashrc
